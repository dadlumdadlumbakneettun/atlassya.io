...
const hwTvCasing=new THREE.Mesh(new THREE.BoxGeometry(0.28,2.7,5.4),new THREE.MeshStandardMaterial({color:0x111111,roughness:0.4,metalness:0.6}));
hwTvCasing.position.set(cx+5.86,2.6,cz-1.5);scene.add(hwTvCasing);
...
hwScreen.position.set(cx+5.71,2.6,cz-1.5);hwScreen.rotation.y=-Math.PI/2;scene.add(hwScreen);
const hwBtnGroup=new THREE.Group();
hwBtnGroup.position.set(cx+5.95,1.3,cz-1.5);
